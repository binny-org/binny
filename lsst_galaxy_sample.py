...
class LSSTGalaxySample:
    ...
    def __init__(self, presets: Presets):
        ...
        with open("parameters/updated_lsst_desc_parameters.yaml", "r") as f:
    ...
    def get_n_eff_clustering(self, decimal_places=2, save_file=True):
        """
        ...
        integrals = [np.trapz(nz, z) for nz in nz_bin_list]
        total = sum(integrals)
    ...
    def get_n_eff_lensing(self, decimal_places=2, save_file=True):
        """
    ...
    def get_n_eff_frac_clustering(self, decimal_places=4, save_file=True):
        """
    ...
    def get_n_eff_frac_lensing(self, decimal_places=4, save_file=True):
        """
