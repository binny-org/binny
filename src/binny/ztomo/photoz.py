"""Photometric-redshift (photo-z) smearing for tomographic binning.
...
# --- _mixed_edges (replace your entire function with this) ---
def _mixed_edges(
    ...
    *,
    ...
    """Build observed-z bin edges from mixed per-segment binning schemes.
